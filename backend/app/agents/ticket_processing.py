"""Ticket-processing workflow for classification, context, priority, and planning."""
...
class TicketProcessingResult:
    """Combined output from the ticket-processing pipeline."""
...
class TicketProcessingWorkflow:
    ...
    async def process_ticket(
        ...
        *,
        ...
        """Run the pipeline and atomically persist its supported ticket fields."""
